...
## 2026-08-06 — Nightly model refresh
...
## 2026-08-05 — Nightly model refresh

- Video detector now at 0.999 AUC with a 0.3% false-positive rate (trained on 7,364 videos).
- Image detector trained on 5,570 samples (AUC 0.843).

## 2026-08-04 — Nightly model refresh

- Video detector now at 0.999 AUC with a 0.3% false-positive rate (trained on 7,364 videos).
- Image detector trained on 5,570 samples (AUC 0.843).

## 2026-08-03 — Nightly model refresh

- Video detector now at 0.999 AUC with a 0.3% false-positive rate (trained on 7,364 videos).
- Image detector trained on 5,570 samples (AUC 0.843).

## 2026-08-02 — Nightly model refresh

- Video detector now at 0.999 AUC with a 0.3% false-positive rate (trained on 7,364 videos).
- Image detector trained on 5,570 samples (AUC 0.843).

## 2026-08-01 — Nightly model refresh

- Video detector now at 0.999 AUC with a 0.3% false-positive rate (trained on 7,364 videos).
- Image detector trained on 5,570 samples (AUC 0.843).

## 2026-07-31 — Nightly model refresh

- Video detector now at 0.999 AUC with a 0.3% false-positive rate (trained on 7,364 videos).
- Image detector trained on 5,570 samples (AUC 0.843).

## 2026-07-30 — Nightly model refresh

- Video detector now at 0.999 AUC with a 0.3% false-positive rate (trained on 7,364 videos).
- Image detector trained on 5,570 samples (AUC 0.843).

## 2026-07-29 — Nightly model refresh

- Video detector now at 0.999 AUC with a 0.3% false-positive rate (trained on 7,364 videos).
- Image detector trained on 5,570 samples (AUC 0.843).

## 2026-07-28 — Nightly model refresh

- Video detector now at 0.999 AUC with a 0.3% false-positive rate (trained on 7,364 videos).
- Image detector trained on 5,570 samples (AUC 0.843).

## 2026-07-27 — Nightly model refresh

- Video detector now at 0.999 AUC with a 0.3% false-positive rate (trained on 7,364 videos).
- Image detector trained on 5,570 samples (AUC 0.843).

## 2026-07-26 — Nightly model refresh

- Video detector now at 0.999 AUC with a 0.3% false-positive rate (trained on 7,364 videos).
- Image detector trained on 5,570 samples (AUC 0.843).

## 2026-07-25 — Nightly model refresh

- Video detector now at 0.999 AUC with a 0.3% false-positive rate (trained on 7,364 videos).
- Image detector trained on 5,570 samples (AUC 0.843).

## 2026-07-24 — Nightly model refresh
...
## 2026-07-21 — Nightly model refresh

- Video detector now at 0.999 AUC with a 0.3% false-positive rate (trained on 7,364 videos).
- Image detector trained on 5,396 samples (AUC 0.842).

## 2026-07-20 — Nightly model refresh

- Video detector now at 0.999 AUC with a 0.3% false-positive rate (trained on 7,364 videos).
- Image detector trained on 5,146 samples (AUC 0.844).

## 2026-07-19 — Nightly model refresh
